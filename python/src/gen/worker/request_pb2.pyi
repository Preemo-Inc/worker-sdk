...
class RegisterFunctionRequest(_message.Message):
    ...
    function_to_register: _shared_pb2.RegisteredFunction
    def __init__(self, function_to_register: _Optional[_Union[_shared_pb2.RegisteredFunction, _Mapping]] = ...) -> None: ...
