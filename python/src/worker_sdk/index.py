...
class PreemoWorker:
    self.__registered_functions_by_name = {"name": lambda x: x * 2}
    ...
    def register(
        ...
        *,
        ...
        # The idea here being that we do something like `python user_file.py function_name params_or_path_to_params params2 params3`
...
def z(*, blah1: int, blah2: int) -> None:
    pass
